#ifndef RTSEIS_FILTERIMPLEMENTATIONS_MEDIANFILTER_HPP
#define RTSEIS_FILTERIMPLEMENTATIONS_MEDIANFILTER_HPP 1
#include <memory>
#include "rtseis/enums.hpp"
namespace RTSeis::FilterImplementations
{
/// @class MedianFilter medianFilter.hpp "rtseis/filterImplementations/medianFilter.hpp"
...
public:
    ...
    /// @result The group delay of the filter.  Note, that this
