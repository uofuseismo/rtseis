...
namespace Filters
{
    ...
    /*!
     * @class MedianFilter filters.hpp "include/rtseis/utilities/filters.hpp"
    ...
    /*!
     * @class FIRFilter filters.hpp "include/rtseis/utilities/filters.hpp"
    ...
    /*!
     * @class IIRFilter filters.hpp "include/rtseis/utilities/filters.hpp"
    ...
    class IIRFilter
    {
         public:
             ...
             enum Implementation
             {
                 DF2_FAST = 0, /*!< A fast IPP implementation that appears 
                                    to only retain 3 digits of accuracy when
                                    compared to Matlab. */
                 DF2_SLOW = 1  /*!< A slow implementation that is consistent
                                    with Matlab. */
             };
        public:
            /*!
            ...
            void clear(void);
    private:
        /*! Forward declaration of IIR filter. */
        class IIRFilterImpl;
    ...
    /*!
     * @class IIRIIRFilter filters.hpp "include/rtseis/utilities/filters.hpp"
