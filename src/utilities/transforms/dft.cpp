...
int DFTRealToComplex::getTransformLength(void) const
{
    if (!pDFT_->isInitialized())
    {
        RTSEIS_ERRMSG("%s", "Class is not intiialized");
...
int DFTRealToComplex::getInverseTransformLength(void) const
{
    if (!pDFT_->isInitialized())
    {
        RTSEIS_ERRMSG("%s", "Class is not intiialized");
...
int DFTRealToComplex::getMaximumInputSignalLength(void) const
{
    if (!pDFT_->isInitialized())
    {
        RTSEIS_ERRMSG("%s", "Class is not intiialized");
...
bool DFTRealToComplex::isInitialized(void) const
{
